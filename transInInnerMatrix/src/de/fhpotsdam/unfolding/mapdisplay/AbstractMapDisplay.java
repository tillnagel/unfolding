...
public abstract class AbstractMapDisplay {
	...
	// REVISIT?
	public double tx2, ty2;
	public double tx3, ty3;
	...
	/** Center of inner transformations in Location. */
	protected PVector innerTransformationCenter;
	public Location innerTransformationLocationNonUsed;
	...
	public abstract void calcInternalTransformationMatrixTemp();
	...
	public void setInnerTransformationCenter(PVector innerTransformationCenter) {
		// For testing purposes; a normal setting would be sufficient
		float x = (float) (innerTransformationCenter.x);
		float y = (float) (innerTransformationCenter.y);
		
		this.innerTransformationCenter = new PVector(x, y);
