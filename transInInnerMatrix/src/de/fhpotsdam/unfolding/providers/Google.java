...
public class Google
{
	...
	public static class GoogleTerrainProvider extends GoogleProvider
	{
		...
		{
			String url = "http://mt1.google.com/vt/v=w2p.116&hl=de&x=" + (int)coordinate.column + "&y=" + (int)coordinate.row + "&z=" + (int)coordinate.zoom + "&s=Galileo";
	...
	public static class GoogleMapProvider extends GoogleProvider
	{
		...
		public String[] getTileUrls(Coordinate coordinate)
		{
			String url = "http://mt1.google.com/vt/lyrs=m@116&hl=de&x=" + (int)coordinate.column + "&y=" + (int)coordinate.row + "&z=" + (int)coordinate.zoom + "&s=Galileo";
			return new String[] { url };
		}
	}
