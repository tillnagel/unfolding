...
/**
 * A feature stores one or more locations, its type, and additional data
 * properties.
 */
public class Feature {
     ...
     *
     * This only returns a non-null value if the value is a String. For String
     * representations of other objects use {@link #getProperty(String)} and
     * convert it yourself.
     *
     * @param key The key of the property.
     * @return The value as String, or null if not found or if property is not a
     * String.
     */
     ...
     *
     * @param key The key of the property.
     * @return The value as Integer, or null if not found or if property is not
     * an Integer.
     */
     ...
     *
     * @param properties The data properties.
     */
