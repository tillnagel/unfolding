 ...
 *
 * Can be used for e.g. JSON's GeometryCollection, but also for MultiPolygons,
 * etc.
 */
public class MultiFeature extends Feature {
    ...
    /**
     * Returns all features of this multi-feature. The features can be of any
     * type, even further MultiFeatures.
     *
     * @return All features.
     */
