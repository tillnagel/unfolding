...
/**
 * A map event for all zoom events, such as (relative) zoomBy and (absolute)
 * zoomTo.
 */
public class ZoomMapEvent extends MapEvent {
    ...
    /**
     * Returns the center of the zoom event, i.e. around which geo-location the
     * map was zoomed in or out.
     *
