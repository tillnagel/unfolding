...
/**
 * A MapEvent stores various information about map events, and can be used to
 * broadcast and listen to. The information consist of the event type (such as
 * zoom, pan, etc), a sub-type (such as zoomBy, zoomTo, etc), and the necessary
 * data to actually perform the map event (such as new zoom level value).
 * <p>
...
public abstract class MapEvent extends EventObject {
     ...
     *
     * @param subType The name of this sub type.
     */
     ...
     *
     * See
     * {@link EventDispatcher#register(MapEventListener, String, String...)}.
     *
