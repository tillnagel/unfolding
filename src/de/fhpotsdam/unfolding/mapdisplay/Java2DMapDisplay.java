...
/**
 * The internal MapDisplay to handle the map display in Processing 2D (and used
 * as super class for 3D)
 */
...
public class Java2DMapDisplay extends AbstractMapDisplay implements PConstants {
    ...
    /**
     * Gets called if all tiles have been loaded. Invokes the tilesLoaded method
     * in the client application if existing.
     *
     * TODO Pass the ID of this map to the method to enable handling multiple
     * maps.
     */
    @Override
    ...
    /**
     * Is called last in {@link #draw()}. May be implemented in sub-classes to
     * handle drawing on outerPG.
     */
