 ...
 * conversions.
 *
 * Use {@link UnfoldingMap} in your application. This is the internal class, and
...
public abstract class AbstractMapDisplay implements TileLoaderListener {
     ...
     *
     * If you have more than one marker manager, use
     ...
     * @param inverse Indicates back and forward matrix calculation. Inverse is
     * used for point2location, non-inverse for location2point.
     ...
     *
     * @param transformationCenter Point in screen coordinates.
     */
     ...
     *
     * @param innerTransformationCenter Point in screen coordinates.
     */
    ...
    /**
     * Will be called if all tiles have been loaded. Subclasses can implement
     * this method to notify a method in the client app.
     */
