...
/**
 * Abstract map provider handles map tiles in combination with the appropriate
 * TileLoader.
 */
public abstract class AbstractMapProvider {
     ...
     *
     * @param coordinate The position and zoom to get tile for.
     * @return A single PImage with the tile.
     */
    public abstract PImage getTile(Coordinate coordinate);

    /**
     * Gets tile URLs for coordinate. May return multiple URLs, if provider
