 ...
 * <li>AbstractMapTileUrlProvider returning an URL from which this TileLoader
 * loads the tile from.</li>
 * </ul>
 *
...
public class TileLoader implements Runnable {
    ...
    /**
     * Indicates whether to try loading again (repeatedly) for tiles which could
     * not be loaded. Uses transparent tile if false.
     */
    private static final boolean TRY_AGAIN_ON_NON_LOADED_TILES = false;

    /**
     * Shows coordinate information for tile, i.e. placed atop original tile
     * image.
     */
