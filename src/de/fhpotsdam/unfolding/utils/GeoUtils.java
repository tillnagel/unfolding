...
public class GeoUtils {
    ...
    /**
     * Get distance in kilometers between two points on the earth. Using the
     * great-circle distance formula with the approximated radius of a spherical
     * earth.
     *
     ...
     * earth.
     *
     * @param location1 Location of first point
     * @param location2 Location of second point
     * @return Distance in kilometers.
     */
     ...
     *
     * Note that this returns the angle as azimuth, i.e. with 0 degrees at
     * north. This differs from the angle used in Processing, where the unit
     * circle starts with 0 degrees at right.
     *
     ...
     *
     * The returned location is the center of the polygon, unfazed by unbalanced
     ...
     *
     * @param originalVertices List of locations of original polygon.
     ...
     *
     * @param locations The locations of the polygon.
     ...
     *
     * @param feature The feature containing location vertices.
     * @return The area in square km.
     */
     ...
     *
     * @param marker The marker containing location vertices.
     * @return The area in square km.
     */
    ...
    /**
     * Returns the centroid of a feature. Returns the single location for a
     * PointFeature, the geometric center for LineFeature and PolygonFeature,
     * and &mdash; depending on the second parameter &mdash; either the overall
     * geometric center of all features, or the geometric center of the largest
     * feature in a MultiFeature.
     *
     * @param feature The feature to get the centroid for.
     * @param useLargestForMulti Set to true if you want to use only the largest
     * feature for {@link MultiFeature}s.
     ...
     *
     * @param multiFeature The MultiFeature consisting of multiple features.
     ...
     *
     * @param multiMarker The MultiMarker consisting of multiple markers.
    ...
    /**
     * Returns all locations of a feature. That is a single location for a
     * point, all locations for lines or polygons, and all locations of all
     * features of a MultiFeature.
     *
     * @param feature The feature to get locations from.
     * @return A list of locations.
     */
    ...
    /**
     * Returns all locations of a marker. That is a single location for a point,
     * all locations for lines or polygons, and all locations of all markers of
     * a MultiMarker.
     *
     * @param marker The marker to get locations from.
     * @return A list of locations.
     */
     ...
     *
     * Does not return the minimum bounding box, i.e. locations spanning the
     * 180th meridian will result in a very large box.
     *
     * @param locations List of locations to get the bounding box for.
     * @return An array of two locations consisting of the north-west and the
     * south-east bounds.
     */
     ...
     * @see
     * <a href="https://developers.google.com/maps/documentation/utilities/polylinealgorithm">Encoded
     * Polyline Algorithm Format - Original algorithm by Google (precision: 5
     * digits)</a>
     *
