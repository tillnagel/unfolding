...
/**
 * A ScreenPosition just a position on the screen. x and y are pixel coordinates
 * in a given map.
 *
 * ScreenPosition offers all the convenient functions of PVector.
 *
 * Map has several functions to translate ScreenPosition to Location and vice
 * versa.
 */
