...
/**
 * Utility class to save large map images. Can be used to create high resolution
 * screenshots for print. Everything currently visible on the map (tiles and
 * markers) will be in the image.
 *
 * This process happens on-screen, thus the map can not be used while this tool
 * is running. It will automatically pan to different areas of the map, stitch
 * them together, and save them in one single image.
 *
 * To customize, set location, zoomLevel, and totalWidth and totalHeight. The
 * latter two should be multiples of xStep and yStep. You can also set file
 * name, or file prefix and file suffix of the large image to be saved.
 *
...
public class LargeMapImageUtils {
    ...
    /**
     * Creates a new LargeMapImageUtils which stores a large image double the
     * size of the canvas.
     *
     * @param p The PApplet
     * @param map The map to take screenshots from.
     */
    ...
    /**
     * Initializes a new large map image around the current map center. Pans to
     * the upper left corner, and start the recording process.
     */
    public void init() {
        running = true;
        shotX = 0;
    ...
    /**
     * Initializes a new large map image around the location. Pans to the upper
     * left corner, and start the recording process.
     *
     * @param location The location to center around.
    ...
    /**
     * Runs the recording process. It will automatically pan to different areas
     * of the map, stitch them together, and save them in one single image, at
     * the end.
     */
    public void run() {
    ...
    /**
     * Internal method to save the actual large stitched-together image in one
     * file.
     */
    ...
    /**
     * Internal method to get the current map canvas (incl markers) and stores
     * it in an buffer image.
     *
     * @param shotX Current x position of the large image to store the current
     * screenshot to.
     * @param shotY Current y position of the large image to store the current
     * screenshot to.
     */
    ...
    /**
     * Sets the prefix of the final large image file. Actual file name will be
     * prefix + number + suffix.
     *
     * @param imageFilePrefix A image file prefix (supported by Processing, i.e.
     * '.tif', '.png', '.jpg').
     */
    ...
    /**
     * Sets the suffix of the final large image file. Actual file name will be
     * prefix + number + suffix.
     *
     * @param imageFileSuffix A image file suffix, e.g. 'largeImage-'.
     */
    ...
    /**
     * The full name of the final large image. If set, the LargeMapImageUtils
     * won't automatically include a number.
     *
     * @param imageFileName A file name.
     */
