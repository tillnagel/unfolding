...
/**
 * Marker representing multiple locations as lines. Use directly to display as
 * simple lines, or extend it for custom styles.
 *
 * This can be a polyline consisting of multiple locations, or a single line
...
public class SimpleLinesMarker extends AbstractShapeMarker {
     ...
     *
     * @param locations The locations to connect via lines.
     */
     ...
     *
     * @param locations The locations to connect via lines.
     * @param properties Optional data properties.
     */
    ...
    /**
     * Creates a marker for a single line, with a connection from start to end
     * location. This convenience method adds the given start and end locations
     * to the list.
     *
     * @param startLocation The location of the start of this line.
     * @param endLocation The location of the end of this line.
     */
