...
/**
 * Abstract marker representing multiple locations and can be implemented as
 * lines, polygons, or other shapes.
 *
 * Handles multiple locations, and implements the main marker methods for
...
public abstract class AbstractShapeMarker extends AbstractMarker {
    ...
    /**
     * Creates an empty shape marker with no locations. Locations can be added
     ...
     *
     * @param locations The list of locations.
     * @param properties Some data properties for this marker.
     */
     ...
     *
     * @param locations One or multiple Location.
     */
     ...
     *
     * NB: Does not set this as the only location! This implementation is just
     * prevent mistakes by using this method as more general Marker method.
     *
     ...
     *
     * @return A list of rings, i.e. a list of lists of locations, or null if
     * shape has no interior rings.
     */
     ...
     *
     * @param interiorRingLocationArray The array of locations for all interior
     * rings.
     */
     ...
     *
     * @param pg The PGraphics to draw on.
     * @param mapPositions The positions in map (, i.e. outer object)
     * coordinates.
     * @param properties The data properties of this marker.
     * @param map The Unfolding map this marker belongs to.
     */
     ...
     *
     * By default, simply calls {@link #draw(PGraphics, List)} and ignores
     * interior rings! Needs to be implemented in sub-class! (See
     * {@link SimplePolygonMarker#draw(PGraphics, List, List)}.)
     *
     * @param pg The PGraphics to draw on.
     * @param mapPositions The positions in map (, i.e. outer object)
     * coordinates.
     * @param ringMapPositionsArray A list of lists of positions (for interior
     * rings).
     */
    ...
    /**
     * Checks whether the position is within the border of the vectors. Uses a
     ...
     *
     * <br/>
     * Note: This is only in AbstractShapeMarker and not in AbstractMarker (nor
     * Marker) as only shape markers have an area to test whether a point is
     * inside. All others (Point and Lines) have no area, and thus an inside
     * check always have to return false.
     *
     * The screen position based {@link #isInside(UnfoldingMap, float, float)}
     * may check whether a point is inside the visual representation, which has
     * an area.
     *
