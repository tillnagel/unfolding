...
public interface Marker {
     ...
     *
     * @param properties The properties to set. The map consist of key,value
     * pairs for each property.
     */
    public void setProperties(HashMap<String, Object> properties);

    /**
     * Sets the property for given key. If properties previously contained a
     * mapping for the key the value is replaced.
     *
    ...
    /**
     * Gets the optional properties of this marker. The map consist of key,value
     * pairs for each property.
     *
    ...
    /**
     * Changes the select status of this marker. Sub-classes can use the
     * selection status to highlight this marker.
     *
     * @param selected Whether this marker is selected or not.
     */
    public void setSelected(boolean selected);

    /**
     * Indicates whether this marker is selected. Can be used for drawing the
     * marker differently, e.g. to highlight it.
     *
     ...
     *
     * @param color The color (in Processing's color type)
     */
     ...
     *
     * @param weight Thickness in pixel.
     */
    public void setStrokeWeight(int weight);

    /**
     * Sets the highlight color of this marker. In the default implementations
     * (SimpleXxMarker), this color is used if the marker is selected.
     *
    ...
    /**
     * Sets the highlight color of this marker's border. In the default
