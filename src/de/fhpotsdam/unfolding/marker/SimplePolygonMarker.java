...
/**
 * Marker representing multiple locations as polygon. Use directly to display as
 * simple colored polygon, or extend it for custom styles.
 *
 * This polygon marker handles interior rings, i.e. holes in the main shape.
 * When in need of multiple connected polygons (e.g. a country and an island)
 * use MultiMarker with Polygons.
 */
public class SimplePolygonMarker extends AbstractShapeMarker {
     ...
     *
     * @param locations The locations to display as polygon.
     */
