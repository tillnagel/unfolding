...
/**
 * Abstract marker handling conversion of location to appropriate coordinate
 * system, and handles basic marker functionality.
 *
 * All default marker of Unfolding implement this. Your own class can extend
 * this AbstractMarker or implement the Marker interface, directly.
 */
public abstract class AbstractMarker implements Marker {
    ...
    /**
     * Draws this marker onto the map. Converts the geo-location to object
     * position, and calls {@link #draw(PGraphics, float, float, UnfoldingMap)}.
     */
    @Override
    ...
    /**
     * Draws a visual representation of this marker. The given x,y coordinates
     * are already converted into the local coordinate system, so no need for
     * further conversion. That is, a position of (0, 0) is the origin of this
     * marker.
     *
     * Subclasses <em>may</em> override this method to draw a marker depending
     * on map properties.
     *
     * @param pg The PGraphics to draw on.
     * @param x The x position in object coordinates.
     * @param y The y position in object coordinates.
     * @param map The map to draw on. Can be used to draw a marker which depends
     * on other properties of the map.
     */
     ...
     *
     * @param pg The PGraphics to draw on
     * @param x The x position in outer object coordinates.
     * @param y The y position in outer object coordinates.
     */
     ...
     *
     * @param checkX The x position to check in screen coordinates.
     * @param checkY The y position to check in screen coordinates.
     * @param x The x position of this marker in screen coordinates.
     * @param y The y position of this marker in screen coordinates.
