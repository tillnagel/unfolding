...
/**
 * Marker representing a single location. Use directly to display as simple
 * circle, or extend it for custom styles.
 */
public class SimplePointMarker extends AbstractMarker {
    ...
    /**
     * Draws this point marker as circle in the defined style. If no style has
     * been set, Unfolding's default one is used.
     */
    @Override
    ...
    /**
     * Sets the radius of this marker. Used for the displayed ellipse and hit
     * test.
     *
     * @param radius The radius of the circle in pixel.
     * @deprecated Fixed behavior! (value was wrongly used as diameter). Use
     * {@link #setDiameter(float)} instead.
     */
    ...
    /**
     * Sets the diameter of this marker. Used for the displayed ellipse and hit
     * test.
     *
