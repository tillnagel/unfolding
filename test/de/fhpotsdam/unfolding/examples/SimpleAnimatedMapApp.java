...
/**
 *
 * OUTDATED. Use setTweening(true) now. This is still useful only as example how
 * to do own animation.
 *
 * Animates a map from one position to another. Uses very simple own animation
 * counter. For smoother animations use some tweening library. Press SPACE to
