...
/**
 * Tracks a path by animating the map along its locations. Centers the map
 * around the current location.
 *
 * Press SPACE to start/stop animation.
 *
 * The path is loaded from a GPX file containing a bike tour in Berlin. Uses
 * GPXUtils for creating TrackPoints, and displays them manually.
 */
