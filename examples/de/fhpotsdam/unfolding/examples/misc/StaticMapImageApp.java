...
/**
 * Uses an UnfoldingMap as static image (e.g. to improve performance when no
 * interaction needed).
 *
 * Storing the mapImage must be done in draw(), as doing so in call-back method
 * tilesLoaded() results in OpenGL error.
 */
