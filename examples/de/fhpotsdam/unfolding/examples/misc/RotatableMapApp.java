...
public class RotatableMapApp extends PApplet {
    ...
    private static PVector rotateCenter = new PVector(350, 250);
    private static Location location = new Location(51.50939f, -0.11820f);
    private static boolean fullRotatable = true;
    ...
    public void draw() {
        background(0);
        map.draw();
        final ScreenPosition pos = map.mapDisplay.getScreenPosition(location);
        stroke(255, 0, 0);
        noFill();
    ...
    public static void main(String[] args) {
        PApplet.main(new String[]{RotatableMapApp.class.getName()});
    }
}
