...
/**
 * Application to compare the two different map rotation styles. Inner-rotate
 * transforms the map itself, and works with all renderers. Outer-rotate
 * transforms the map container, and works with GLGraphics only.
 *
 * Use r and l to inner rotate clock-wise (right), and counter-clock-wise
 * (left), and respectively R and L to outer rotate. Note, in this example the
 * map rotates around the current mouse pointer.
 */
