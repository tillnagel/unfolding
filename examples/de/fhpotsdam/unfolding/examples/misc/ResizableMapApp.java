 ...
 *
 * Drag the window frame (depending on your OS) to resize, or press SPACE to
 * resize randomly.
 *
 * The map will be resized, but everything else stays the same, i.e. even the
 * current transformation center will be consistent. If the frame size was
 * increased, the missing tiles will be loaded, and added automatically.
 */
