 ...
 *
 * The information widget also shows map events, as the eventDispatcher is
 * passed to the DebugDisplay.
 *
 * @see
 * {@link de.fhpotsdam.unfolding.examples.events.ComplexMapEventApp ComplexMapEventApp}
 * for DebugDisplays showing complex map events.
 */
