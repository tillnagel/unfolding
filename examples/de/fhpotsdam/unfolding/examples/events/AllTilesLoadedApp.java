 ...
 *
 * If after a map manipulation (zoom, pan, provider switch, etc) new tiles have
 * to be loaded, the tilesLoaded method will be called automatically in your
 * sketch if it exists. In that method you can do whatever you want, e.g. create
