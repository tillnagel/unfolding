...
public class SimplePositionConversionMapApp extends PApplet {
    ...
    public void draw() {
        ...
        final Location loc = new Location(52.5f, 13.4f);
        final ScreenPosition pos = map.getScreenPosition(loc);
        ellipse(pos.x, pos.y, 20, 20);

        final String berlinDescription = "Berlin at pixel (" + (int) pos.x + "," + (int) pos.y + ")";
