...
public class NaviButtonMapEventsApp extends PApplet {
    ...
    private static final Location berlinLocation = new Location(52.51861f, 13.408056f);
    private static final int berlinZoomLevel = 10;
    private static final Location universityLocation = new Location(52.411613f, 13.051779f);
    private static final int universityZoomLevel = 14;
    ...
    public void mouseReleased() {
        if (mouseX > 610 && mouseX < 790 && mouseY > 210 && mouseY < 290) {
            ...
            final PanMapEvent panMapEvent = new PanMapEvent(this, mapDetail.getId());
            panMapEvent.setToLocation(berlinLocation);
            eventDispatcher.fireMapEvent(panMapEvent);

            final ZoomMapEvent zoomMapEvent = new ZoomMapEvent(this, mapDetail.getId(), ZoomMapEvent.ZOOM_TO_LEVEL);
