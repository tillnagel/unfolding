...
public class MBTilesMapApp extends PApplet {
    ...
    private static final String TILES_LOCATION_APPLICATION = "./bin/tiles/blankLight-1-3.mbtiles";
    private static final String TILES_LOCATION_APPLET = "./tiles/blankLight-1-3.mbtiles";

    private static String mbTilesString = TILES_LOCATION_APPLET;
    ...
    public static void main(String[] args) {
        ...
        PApplet.main(new String[]{MBTilesMapApp.class.getName()});
    }
}