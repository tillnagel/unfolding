...
/**
 * Overlays two different map areas depicting the same earth areas. Apparently
 * some satellite images must have been inserted at the wrong position. This is
 * on Microsoft Satellite, as well as on Google Satellite.
 *
 * <p>
 * ctrl + mouse move to change the alpha level of the top map. Press 'a' and 'd'
 * to rotate (in order to align both maps.)
 * </p>
 */
