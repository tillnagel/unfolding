...
public class MapComparisonApp extends PApplet {
    ...
    public static final Location location = new Location(53.015f, 8.2f);

    private EventDispatcher eventDispatcher;
    private UnfoldingMap mapOSM;
    private UnfoldingMap mapOSMSmall;
    private UnfoldingMap mapOSMSmallSatBlend;
    private UnfoldingMap mapOSMSmallOSMBlend;
    private UnfoldingMap mapOSMSmallSat;
    private UnfoldingMap mapGoogle;
    private UnfoldingMap mapGoogleSmall;
    private UnfoldingMap mapGoogleSmallSatBlend;
    private UnfoldingMap mapGoogleSmallGoogleBlend;
    private UnfoldingMap mapGoogleSmallSat;
    ...
    public void setup() {
        ...
        final MouseHandler mouseHandler = new MouseHandler(this, mapOSM, mapGoogle);
        eventDispatcher.addBroadcaster(mouseHandler);

        // All maps listen to events from both broadcasters
        final List<MapEventListener> maps = new ArrayList<MapEventListener>();
        maps.add(mapOSM);
    ...
    private void zoomAndPanTo(final Location location) {
