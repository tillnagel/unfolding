...
public class TransitLinesMarkerApp extends PApplet {
    ...
    private Location bostonLocation = new Location(42.357778f, -71.061667f);
    ...
    public void setup() {
        ...
        final List<Feature> transitLines = GeoJSONReader.loadData(this, "data/MBTARapidTransitLines.json");

        // Create marker from features, and use LINE property to color the markers.
        final List<Marker> transitMarkers = new ArrayList<Marker>();
        for (final Feature feature : transitLines) {
            final ShapeFeature lineFeature = (ShapeFeature) feature;

            final SimpleLinesMarker m = new SimpleLinesMarker(lineFeature.getLocations());
            final String lineColor = lineFeature.getStringProperty("LINE");
            int color = 0;
