...
/**
 * Loads a GPX file containing a bike tour in Berlin, and displays each segment
 * with speed mapped to color.
 *
 * This example shows a more complex usage of own data loading and special
 * markers. See @{link GPXSpeedReader} for how to create your own data reader
 * creating geo-data Features.
 */
