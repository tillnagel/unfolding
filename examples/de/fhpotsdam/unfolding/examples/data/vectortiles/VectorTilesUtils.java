...
/**
 * Helper class to load and parse vector tiles. Loads features and markers for a
 * single vector tile.
 */
public class VectorTilesUtils {
    ...
    /**
     * Creates this VectorTilesUtils for the given applet and the given map.
     * Uses Mapzen's Vector Tiles server.
     *
