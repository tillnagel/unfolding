...
/**
 * Simple example for dynamic marker handling. This adds, removes and clears
 * markers of a single MarkerManager.
 *
 * Press 'r' to remove the Berlin marker, 'a' to re-add it, and 'c' to clear all
 * markers.
 */
