 ...
 * Highlights one of the markers and shows its label when user hovers over the
 * mouse. Selection works out-of-the-box, but for using the 'title' property as
 * label a special method has to be called.
 *
 * The highlight check is done manually for all markers in mouseMoved().
 *
 * If you want to prevent label overlapping, you either need to re-sort the
 * markers, or create two marker sets, one for the dots, and one for the labels.
 *
 */
