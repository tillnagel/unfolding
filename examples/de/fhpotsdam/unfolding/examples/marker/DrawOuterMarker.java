...
/**
 * Example for implementing and designing your own Marker (by extending the AbstractMarker).
 * Simple marker, implementing the drawOuter method instead of the main draw method. The given x,y coordinates are already
