...
public class SimpleNonMarkerApp extends PApplet {
    ...
    private Location locationBerlin = new Location(52.5f, 13.4f);
    private Location locationLondon = new Location(51.5f, 0f);
    ...
    public void draw() {
        ...
        // Fixed-size element
        final ScreenPosition xyBerlin = map.getScreenPosition(locationBerlin);
        fill(0, 200, 0, 100);
        ellipse(xyBerlin.x, xyBerlin.y, 20, 20);

        // Zoom dependent element size
        final ScreenPosition xyLondon = map.getScreenPosition(locationLondon);
        fill(200, 0, 0, 100);
        float s = map.getZoom();
