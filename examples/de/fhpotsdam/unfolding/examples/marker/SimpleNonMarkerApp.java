...
/**
 * Displays two dots, by simply updating their position based on their
 * locations. Look into Unfolding's Marker mechanism, if you want to use
 * interactivity, load data or do anything else more than simply showing dots.
 *
 * <p>
 * Note, that this simple mechanism only works for full-sized maps (i.e. the
 * markers are shown off-map, too). For usage of MarkerManager look into other
 * examples, e.g. {@link SimpleMarkerManagerApp}.
 * </p>
 */
