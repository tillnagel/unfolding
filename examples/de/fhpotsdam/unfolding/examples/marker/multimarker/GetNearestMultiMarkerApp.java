...
/**
 * Example application to demonstrate nearest marker test.
 * 
 * getNearestMarker(x,y) returns the closest marker to the given screen position. Using
 * DistancePerLocationPolygonMarker, i.e. instead of the default implmentation of using the centroid of the polygon,
