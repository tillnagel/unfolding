...
/**
 * Manual multi-marker example showing two polygons for France and Corsica to
 * demonstrate a multi marker. By hovering over one of the two areas the whole
 * MultiMarker gets selected, thus both areas are highlighted.
 *
 * <p>
 * <em>Note, that loading Unfolding's DataReader automatically creates and
 * handles multi-marker.</em>
 * </p>
 *
 * Set the boolean useMultiMarker to false to see the same areas as independent
 * markers.
 */
