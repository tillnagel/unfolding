...
public class MultiMarkerApp extends PApplet {
    ...
    private boolean useMultiMarker = true;
    ...
    public void setup() {
        ...
        final SimplePolygonMarker franceMarker = new SimplePolygonMarker(getFranceShapeLocations());
        final SimplePolygonMarker corsicaMarker = new SimplePolygonMarker(getCorsicaShapeLocations());
    ...
    public void mouseMoved() {
        ...
        final Marker hitMarker = map.getDefaultMarkerManager().getFirstHitMarker(mouseX, mouseY);
        if (hitMarker != null) {
    ...
    public static List<Location> getFranceShapeLocations() {
        //
        final List<Location> franceLocations = new ArrayList<Location>();
    ...
    public static List<Location> getCorsicaShapeLocations() {
        final List<Location> corsicaLocations = new ArrayList<Location>();
