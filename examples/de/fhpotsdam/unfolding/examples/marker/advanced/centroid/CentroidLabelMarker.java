...
/**
 * Displays the polygon ID as label at the geometric center of its shape. For
 * this, it uses the geo-spatial centroid of the polygon, and converts it to
 * object coordinates, to be consistent to other marker draw methods.
 */
