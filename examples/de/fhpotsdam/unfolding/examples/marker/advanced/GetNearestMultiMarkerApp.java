 ...
 *
 * getNearestMarker(x,y) returns the closest marker to the given screen
 * position. Using DistancePerLocationPolygonMarker, i.e. instead of the default
 * implementation of using the centroid of the polygon, this tests all vertices
 * of the polygon.
 */
