...
/**
 * Simple example with three markers, managed by the default MarkerManager. Displays two point markers, and one line marker.
 * <p>
...
public class SimpleMarkerManagerApp extends PApplet {
    ...
    public void setup() {
        ...
        // Point Markers
        final SimplePointMarker berlinMarker = new SimplePointMarker(berlinLocation);
